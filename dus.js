...
kub.addEventListener('click',function () {
    baskub.setAttribute('src','https://m.media-amazon.com/images/I/91GVw3oOoVL._AC_UF350,350_QL80_.jpg')
    
})

kubA.addEventListener('click',function () {
    baskub.setAttribute('src','https://images-eu.ssl-images-amazon.com/images/I/51duZ+yhbZL._AC_UL330_SR330,330_.jpg' )
})
kubB.addEventListener('click',function () {
    baskub.setAttribute('src','https://cdn.master.az/wp-content/uploads/2022/11/dus-kabin-qizili-seffaf.jpg' )
})
kubC.addEventListener('click',function () {
    baskub.setAttribute('src','https://omid.az/upload/API/ef464d590caff9438356d1f39c211b94.jpg' )
})
kubD.addEventListener('click',function () {
    baskub.setAttribute('src','https://omid.az/upload/API/c59c66a8c1200bbf20828bc6aa836115.jpg' )
})
