...
kub.addEventListener('click',function () {
    baskub.setAttribute('src','https://ph-test-11.slatic.net/original/96c0306a6dc392f20edb9dbe1b9c8d70.jpg')
...
kubB.addEventListener('click',function () {
    baskub.setAttribute('src','https://ph-test-11.slatic.net/p/5682a9f50c8428d4b92969fb119b8039.jpg' )
})
kubC.addEventListener('click',function () {
    baskub.setAttribute('src','https://www.static-src.com/wcsstore/Indraprastha/images/catalog/medium//98/MTA-7548713/oldoak_oldoak_lazypod_for_gadget_full06_fpd082yi.jpg' )
})
kubD.addEventListener('click',function () {
    baskub.setAttribute('src','https://www.static-src.com/wcsstore/Indraprastha/images/catalog/full//87/MTA-9206114/baseus_lazypod_ipad_tablet_baseus_lazy_pod_phone_holder_penyangga_stand_tab_full01_gctu0mh8.jpg' )
})
