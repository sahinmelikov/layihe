...
kub.addEventListener('click',function () {
    baskub.setAttribute('src','https://unvan.az/uploads/news/157656699911044267965df880d754068.png')
    
})

kubA.addEventListener('click',function () {
    baskub.setAttribute('src','https://s.ucuztap.az/storage/a/1699073/lg/5f369eea35087.jpg' )
})
kubB.addEventListener('click',function () {
    baskub.setAttribute('src','https://unvan.az/uploads/news/15773472446072041995e0468ac5a582.png' )
})
kubC.addEventListener('click',function () {
    baskub.setAttribute('src','http://birja-in.az/loadfiles/moduls/doska/bigfoto/yukdasima-xidmeti-11d9cca68b.jpeg' )
})
kubD.addEventListener('click',function () {
    baskub.setAttribute('src','https://img5.lalafo.com/i/posters/api_webp/8e/fd/60/3ff2f4ce574373418ecdb38025.webp' )
})
